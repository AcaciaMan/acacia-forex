...
public class CurrencyPair1Month extends CurrencyPair{
        public CurrencyPair1Month() {
    periodEnum = CalcPeriodEnum.MONTH;
    }
    ...
    public LocalDate findStart(Rate lastRate) {
        ...
        LocalDate result = lastRate.refDate.minusDays(30);
