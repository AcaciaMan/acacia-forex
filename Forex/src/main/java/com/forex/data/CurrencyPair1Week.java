...
public class CurrencyPair1Week extends CurrencyPair{
        public CurrencyPair1Week() {
    periodEnum = CalcPeriodEnum.WEEK;
    }
    ...
    public LocalDate findStart(Rate lastRate) {
        ...
        LocalDate result = lastRate.refDate.minusDays(6);
